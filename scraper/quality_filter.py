...
NOISE_PATTERNS = [
    ...
    r"^designation of",
    r"^letters? to the",
    # Military/DOD boilerplate — routine operations, not market-moving
    r"war department",
    r"special warfare",
    r"special operations",
    r"armed services committee",
    r"house armed services",
    r"senate armed services",
    r"military readiness",
    r"force posture",
    r"homeland defense",
    r"hemispheric security",
    r"force structure",
    r"military exercise",
    r"joint exercise",
    r"naval exercise",
    r"troop deployment",
    r"base (closure|realignment)",
    r"medal of honor",
    r"purple heart",
    r"change of command",
    r"assumes command",
    r"takes command",
    r"relinquishes command",
